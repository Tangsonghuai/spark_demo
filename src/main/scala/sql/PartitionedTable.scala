...
object PartitionedTable {
  ...
  def main(args: Array[String]) {
    ...
    val df07= spark.sql("select * from original ");
//      s"""
...
//      """.stripMargin)
 import org.apache.spark.sql.SaveMode
    ...
    df07.write.mode(SaveMode.Overwrite).jdbc("jdbc:mysql://localhost:3306/test?useUnicode=true&characterEncoding=utf8&rewriteBatchedStatements=true&useSSL=false&serverTimezone=UTC&allowPublicKeyRetrieval=true","New_table",properties)
    print("----EO---")
    //
